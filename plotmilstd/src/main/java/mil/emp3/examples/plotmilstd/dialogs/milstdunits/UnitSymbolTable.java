...
import mil.emp3.examples.plotmilstd.dialogs.milstdunits.UnitSymbolDefTreeItem;
import mil.emp3.examples.plotmilstd.utils.StringVersionComparator;
...
public class UnitSymbolTable {
    ...
    public final void loadUnitDef(org.cmapi.primitives.GeoMilSymbol.SymbolStandard eStdVersion) {
        ...
        int iMilStdVersion = (eStdVersion == org.cmapi.primitives.GeoMilSymbol.SymbolStandard.MIL_STD_2525B)?
                armyc2.c2sd.renderer.utilities.MilStdSymbol.Symbology_2525Bch2_USAS_13_14:
        ...
        // We need to create a dummy root because the render SDK don not have
